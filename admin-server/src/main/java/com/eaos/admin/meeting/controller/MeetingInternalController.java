...
public class MeetingInternalController {
    ...
    public R<?> progress(@PathVariable Long taskId, @Valid @RequestBody MeetingProgressPayload payload,
    ...
    public R<?> result(@PathVariable Long taskId, @RequestBody MeetingResultPayload payload,
                       HttpServletRequest request) {
        verify(request);
    ...
    public R<?> failure(@PathVariable Long taskId, @RequestBody Map<String, Object> payload,
                        HttpServletRequest request) {
        verify(request);
