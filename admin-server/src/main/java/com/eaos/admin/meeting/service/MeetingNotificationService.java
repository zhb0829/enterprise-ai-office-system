...
public class MeetingNotificationService {
    ...
    public void notify(Long userId, String type, String title, String content, String refType, Long refId) {
        if (userId == null) {
            return;
        }
    ...
    public Map<String, Object> page(Long userId, int page, int pageSize) {
        LambdaQueryWrapper<UserNotification> wrapper = Wrappers.lambdaQuery(UserNotification.class)
    ...
    public long unreadCount(Long userId) {
        return notificationMapper.selectCount(Wrappers.lambdaQuery(UserNotification.class)
                .eq(UserNotification::getUserId, userId)
    ...
    public void markAllRead(Long userId) {
        ...
        notificationMapper.update(patch, Wrappers.lambdaQuery(UserNotification.class)
                .eq(UserNotification::getUserId, userId)
                .eq(UserNotification::getIsRead, false));
    }
}
