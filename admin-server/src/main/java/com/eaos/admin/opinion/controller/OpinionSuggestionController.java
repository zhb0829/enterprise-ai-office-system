...
public class OpinionSuggestionController {
  ...
  @GetMapping
  public R<List<OpinionSuggestion>> list(
  ...
  public R<OpinionSuggestion> generate(
      @RequestParam String targetType, @RequestParam Long targetId) {
    return R.ok(service.generate(targetType, targetId));
  }

  @PostMapping("/{id}/feedback")
  public R<OpinionSuggestion> feedback(
      @PathVariable Long id, @Valid @RequestBody SuggestionFeedbackRequest request) {
