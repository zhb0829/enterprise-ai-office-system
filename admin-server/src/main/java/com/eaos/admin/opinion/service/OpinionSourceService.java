...
public class OpinionSourceService {
  ...
  public OpinionSource create(OpinionSourceRequest request, boolean admin) {
    ...
    auditService.record(
        ...
        "opinion_source",
        source.getId(),
        Map.of("name", source.getName(), "homepage", source.getHomepage()),
        null);
    return source;
  }
  ...
  public OpinionSource update(Long id, OpinionSourceRequest request, boolean admin) {
    ...
    auditService.record(
        "SOURCE_UPDATE", "opinion_source", id, Map.of("name", source.getName()), null);
    return source;
  }
  ...
  public void delete(Long id, boolean admin) {
    ...
    auditService.record(
        "SOURCE_DELETE", "opinion_source", id, Map.of("name", source.getName()), null);
  }
  ...
  public OpinionSource audit(Long id, SourceAuditRequest request, boolean admin) {
    ...
    auditService.record(
        ...
        "opinion_source",
        id,
        Map.of("auditStatus", auditStatus, "note", request.getAuditNote()),
        null);
    return source;
  }
