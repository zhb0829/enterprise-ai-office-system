...
public class OpinionMonitorService {
    ...
    public OpinionMonitor create(OpinionMonitorRequest request) {
        ...
        auditService.record("MONITOR_CREATE", "opinion_monitor", monitor.getId(),
                Map.of("name", monitor.getName()), null);
        return monitor;
    }
    ...
    public OpinionMonitor update(Long id, OpinionMonitorRequest request) {
        ...
        auditService.record("MONITOR_UPDATE", "opinion_monitor", id,
                Map.of("name", monitor.getName()), null);
        return monitor;
    }
    ...
    public void delete(Long id) {
        ...
        auditService.record("MONITOR_DELETE", "opinion_monitor", id,
                Map.of("name", monitor.getName()), null);
    }
    ...
    private void apply(OpinionMonitor monitor, OpinionMonitorRequest request) {
        ...
        monitor.setTimeWindowDays(request.getTimeWindowDays() == null ? 7 : request.getTimeWindowDays());
