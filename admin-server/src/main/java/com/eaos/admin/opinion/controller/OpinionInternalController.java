...
public class OpinionInternalController {
    ...
    public Map<String, Object> ingest(@Valid @RequestBody IngestArticlesRequest request, HttpServletRequest http) {
        requireToken(http);
        return articleService.ingest(request);
    }

    @PostMapping("/source-tasks/{taskId}/failure")
    public Map<String, Object> sourceTaskFailure(@PathVariable Long taskId,
    ...
    public Map<String, Object> next(@RequestParam(defaultValue = "python-worker") String worker, HttpServletRequest http) {
        requireToken(http);
    ...
    public Map<String, Object> failure(@PathVariable Long taskId,
    ...
    public Map<String, Object> spreadIngest(@Valid @RequestBody SpreadIngestRequest request, HttpServletRequest http) {
        requireToken(http);
