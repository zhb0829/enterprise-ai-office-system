...
public class OpinionSourceController {
    ...
    @GetMapping
    public R<List<OpinionSource>> list(@RequestParam(required = false) String auditStatus,
    ...
    @PutMapping("/{id}")
    public R<OpinionSource> update(@PathVariable Long id, @Valid @RequestBody OpinionSourceRequest request) {
    ...
    public R<OpinionSource> audit(@PathVariable Long id, @Valid @RequestBody SourceAuditRequest request) {
