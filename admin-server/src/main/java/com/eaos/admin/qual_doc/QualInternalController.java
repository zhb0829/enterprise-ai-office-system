...
public class QualInternalController {
    ...
    public void progress(@RequestHeader(value = "X-Internal-Token", required = false) String token,
    ...
    @PostMapping("/result")
    public void result(@RequestHeader(value = "X-Internal-Token", required = false) String token,
    ...
    @PostMapping("/failure")
    public void failure(@RequestHeader(value = "X-Internal-Token", required = false) String token,
