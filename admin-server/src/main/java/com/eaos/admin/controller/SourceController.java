...
public class SourceController {
  ...
  @GetMapping
  public R<List<SourceConfig>> list() {
    return R.ok(service.listSources());
  }
  ...
  @PutMapping("/{id}")
  public R<SourceConfig> update(
      @PathVariable Long id, @Valid @RequestBody SourceConfigRequest request) {
