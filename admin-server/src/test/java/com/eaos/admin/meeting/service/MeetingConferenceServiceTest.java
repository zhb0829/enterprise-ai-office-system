...
class MeetingConferenceServiceTest {
  ...
  @Mock private ConferenceMaterialMapper materialMapper;
  @Mock private ConferenceReportMapper reportMapper;
  @Mock private KnowledgeCardMapper cardMapper;
  @Mock private ConferenceTaskMapper taskMapper;
  @Mock private ConferenceMediaMapper mediaMapper;
  @Mock private MeetingStorageService storageService;
  @Mock private MeetingTaskService taskService;

  @InjectMocks private MeetingConferenceService service;

  @BeforeEach
  void setUpAdminContext() {
    LoginUser admin = new LoginUser(1L, "admin", "secret", "管理员", "ADMIN", true);
  ...
  void addLinkRejectsExactDuplicateUrl() {
    ...
    IllegalArgumentException error =
        assertThrows(IllegalArgumentException.class, () -> service.addLink(1L, request));
